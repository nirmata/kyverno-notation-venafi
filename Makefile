...
.PHONY: install-kyverno-notation-venafi
install-kyverno-notation-venafi: $(HELM) ## Install kyverno notation venafi helm chart
	@echo Install kyverno chart... >&2
	@$(HELM) upgrade --install kyverno-notation-venafi --namespace kyverno-notation-venafi --create-namespace --wait ./charts/kyverno-notation-venafi
